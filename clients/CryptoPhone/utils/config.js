...
export const SERVER_CONFIG = {
	// 本地测试（浏览器测试用localhost，手机测试用局域网IP）
	LOCAL: 'http://localhost:8080',
	// 局域网测试（手机需要与电脑在同一WiFi）
...
export const API_ENDPOINTS = {
	// 阿里云语音服务（使用完整URL避免H5环境跨域问题）
	ALIYUN_CONFIG: SERVER_CONFIG.CURRENT + '/api/aliyun/config',
	ALIYUN_TTS: SERVER_CONFIG.CURRENT + '/api/aliyun/tts',
	ALIYUN_ASR: SERVER_CONFIG.CURRENT + '/api/aliyun/asr',
	// 扣子AI
	COZE_AI: SERVER_CONFIG.CURRENT + '/api/coze',
	// CoinMarketCap
	CRYPTO_DATA: SERVER_CONFIG.CURRENT + '/api/crypto/latest'
}
