...
# 🔑 配置区域（建议优先用环境变量覆盖）
# ==========================================
# 你也可以不改文件，直接在 PowerShell 设置：
# $env:ALIYUN_ACCESS_KEY_ID='...'
# $env:ALIYUN_ACCESS_KEY_SECRET='...'
# $env:ALIYUN_NLS_APPKEY='...'

ACCESS_KEY_ID = ""  # 可留空，优先从环境变量 ALIYUN_ACCESS_KEY_ID 读取
ACCESS_KEY_SECRET = ""  # 可留空，优先从环境变量 ALIYUN_ACCESS_KEY_SECRET 读取
NLS_APPKEY = "8EGo7ZLfZynITFDC"  # 可被环境变量 ALIYUN_NLS_APPKEY 覆盖
